...
REM Brute force
set CP=%CP%;%EC2_HOME%\lib\AWSEC2JavaClient-1.9ux.jar
set CP=%CP%;%EC2_HOME%\lib\AWSJavaClientJmxSPI-external_release_1.9.jar
set CP=%CP%;%EC2_HOME%\lib\AWSJavaClientRuntime-external_release_1.9.jar
set CP=%CP%;%EC2_HOME%\lib\AWSJavaCredentialInterfaces-1.0.jar
set CP=%CP%;%EC2_HOME%\lib\AWSS3JavaClient-external_release_1.9.jar
...
set CP=%CP%;%EC2_HOME%\lib\ec2-api-tools-1.7.4.0.jar
set CP=%CP%;%EC2_HOME%\lib\httpclient-4.2.3.jar
set CP=%CP%;%EC2_HOME%\lib\httpcore-4.2.jar
set CP=%CP%;%EC2_HOME%\lib\j2ee_mail.jar
set CP=%CP%;%EC2_HOME%\lib\jackson-annotations-2.3.2.jar
set CP=%CP%;%EC2_HOME%\lib\jackson-core-2.3.2.jar
set CP=%CP%;%EC2_HOME%\lib\jackson-databind-2.3.2.jar
...
set CP=%CP%;%EC2_HOME%\lib\joda-time-2.3.jar
...
set CP=%CP%;%EC2_HOME%\lib\xmlsec-1.4.8.jar
set CP=%CP%;%EC2_HOME%\lib\xmlsecSamples-1.4.8.jar
set CP=%CP%;%EC2_HOME%\lib\xmlsecTests-1.4.8.jar
